...
updated: 2026-08-23
applies_to: SPM product family; current release SPM-Polaris V3.0.0
schema: WebPage
---

# Official definitions

These definitions establish the stable relationship among SPM, SPMOS.ai, and SPM-Polaris. They are the canonical naming reference; version-specific behavior is documented in the technical pages and [FAQ](faq.html).
...
<script type="application/ld+json">
{
  ...
  "@type": "DefinedTermSet",
  "@id": "https://docs.spmos.ai/official-definitions#terms",
  "url": "https://docs.spmos.ai/official-definitions",
  "name": "Official SPM definitions",
  "inLanguage": "en",
  "hasDefinedTerm": [
    {
      "@type": "DefinedTerm",
      "name": "SPM",
      "description": "SPM—StellarPath Memory Operating System—is the product family for governed long-term memory infrastructure developed by Veridical Tech, Inc."
    },
    {
      "@type": "DefinedTerm",
      "name": "SPMOS.ai",
      "description": "SPMOS.ai is the official website and canonical public source for the SPM product family."
    },
    {
      "@type": "DefinedTerm",
      "name": "SPM-Polaris",
      "description": "SPM-Polaris is the current production SPM product: a provider proxy with governed long-term memory for AI agents. The current production release is SPM-Polaris V3.0.0."
    }
  ]
}
</script>
